    ...
    return (
        <div>
            <div className="flex justify-start items-start gap-4">
                <div className="w-[30px] hidden pt-2 text-center md:flex flex-col justify-between items-center gap-2">
                ...
                <div className="right w-full">
                    ...
                    </div>
                    {
                        hasInfo && <div className="infobox mt-4 bg-[#FFEEDB] px-3 py-2 rounded w-full flex justi items-center gap-3">
                            <FaInfoCircle className='text-[#F27D00] text-xl min-w-[20px] block' />
                            <p className='text-sm'>
